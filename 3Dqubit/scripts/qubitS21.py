...
myVNA.min_freq = 7.29e9 - 50e6 # 7.4297463e9 - 50e6 # hot
myVNA.max_freq = 7.29e9 + 50e6 # 7.4297463e9 + 50e6 # hot
...
for Sij in ["S21"]: #["S11", "S12", "S21", "S22"]:
    basename = f"../data/qubit_hot_3PC/{int(T * 1e3)}mK_{myVNA.bandwidth / 1e3}kHz_{myVNA.power}dBm_S11"
    ...
    metadata = {
        ...
        #"info": "cavity with qubit, three port configuration for S21 = H_i + H_o", 
